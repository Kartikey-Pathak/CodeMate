...
function IssueForm() {
    ...
    return (
        <>
            <Nav />
            <div className="bg-[#0D1117] h-screen w-full max-w-screen relative">
                <form action="" className=" h-full w-full">
                    <div className=" h-full w-full flex items-start flex-col gap-3">
                        ...
                        <div className=" flex flex-col items-start justify-start h-[40rem] gap-1 w-[80%] max-w-[80rem] ml-10">
                        ...
                        <div className=" w-full h-80">
                            <div className=" flex flex-col items-start justify-start h-24 gap-1 w-[80%] max-w-[60rem] ml-10 ">
                                <p className=" font-semibold">Add a repo <span  className=" text-red-500">*</span></p>
                                <input onFocus={() => { setblue3(true) }} onBlur={() => { setblue3(false) }} type="text" placeholder="Repo link" className={` outline-none p-4 w-full ${blue3 ? "border-blue-600" : "border-gray-600"} rounded-md h-8  border-2`} />
                            </div>
                        </div>
                    </div>
                
                <button className=" h-12 w-32 bg-green-600 hover:bg-green-700 transition-all cursor-pointer absolute z-[200] right-5 bottom-4 rounded-xl flex items-center justify-center text-white  font-semibold">Create</button>
